...
- Database layer: SQL Server username/password from environment variables.
...
- `CONFIG_INVALID`: environment variable is present but invalid.
...
- Proposed defaults for PM/SD review:
  - `MSSQL_PORT`: `1433`
  - `MSSQL_TRUST_SERVER_CERTIFICATE`: `yes`
  - `MSSQL_DRIVER`: `ODBC Driver 18 for SQL Server`
- Final defaults should be documented in README during implementation.
